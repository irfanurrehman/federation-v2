# Creating and updating the KubeFed website

Welcome to the GitHub repository for KubeFed's public website. The docs are
hosted at https://docs.kubefed.io.
...
* Please see [How to contribute](CONTRIBUTING.md) for instructions on how to contribute, if you are not familiar with the
  GitHub workflow
* [Start contributing](https://kubefed.netlify.com/docs/about/contributing/)
...
1. Fork the [kubefed repo][kubefed-website-repo] on GitHub.
...
1. When you're ready for a review, add a comment to the PR and assign a
  ...
  [Kubefed contributor guide][kubefed-contributor-guide].
...
[kubefed-contributor-guide]: CONTRIBUTING.md
[kubefed-website-repo]: https://github.com/kubernetes-sigs/federation-v2
