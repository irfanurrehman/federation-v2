...
import (
	...
	fsv1a1 "github.com/kubernetes-sigs/federation-v2/pkg/apis/scheduling/v1alpha1"
	fedclientset "github.com/kubernetes-sigs/federation-v2/pkg/client/clientset/versioned"
	fsv1a1client "github.com/kubernetes-sigs/federation-v2/pkg/client/clientset/versioned/typed/scheduling/v1alpha1"
...
var _ = Describe("FederatedJobScheduling", func() {
	f := framework.NewFederationFramework("federated-job-scheduling")
	tl := framework.NewE2ELogger()

	const userAgent = "test-federated-scheduling"
	const baseName = "test-federated-scheduling-"

	var fedClient fedclientset.Interface
	var namespace string
	var jspClient fsv1a1client.JobSchedulingPreferenceInterface

	objectGetter := func(namespace, name string) (pkgruntime.Object, error) {
		jspClient := fedClient.Scheduling().JobSchedulingPreferences(namespace)
		return jspClient.Get(name, metav1.GetOptions{})
	}
